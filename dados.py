...
print("-- INSERT Times")
for t in range(20):
    print(f"INSERT INTO Time (nome, cidade, estadio) VALUES ('{times[t][1]}', '{times[t][2]}', '{times[t][3]}');")

print("\n-- INSERT Campeonato")
print(f"INSERT INTO Campeonato (id,nome, ano) VALUES ('{campeonato[0]}','{campeonato[1]}', {campeonato[2]});")

print("\n-- INSERT Jogadores")
for j in jogadores:
    print(f"INSERT INTO Jogador (nome, idade, nacionalidade, time, posicao) VALUES ('{j['nome']}', {j['idade']}, '{j['nacionalidade']}', '{j['time']}', '{j['posição']}');")

print("\n-- INSERT Árbitros")
for a in arbitros:
    print(f"INSERT INTO Arbitro (nome, categoria, federacao) VALUES ('{a['nome']}', '{a['categoria']}', '{a['sexo']}');")

print("\n-- INSERT Participação")
for t in range(20):
    print(f"INSERT INTO Participa (campeonato_id, time_id) VALUES ({campeonato[0]}, {times[t][0]});")

print("\n-- INSERT Partidas")
for p in partidas:
    print(f"INSERT INTO Partida (campeonato_id, rodada, time1_id, time2_id, data, placar_time1, placar_time2) VALUES ({p['campeonato_id']}, {p['rodada']}, {p['time1_id']}, {p['time2_id']}, '{p['data']}', {p['placar_time1']}, {p['placar_time2']});")

print("\n-- INSERT Árbitros em Partidas (Joga)")
for p in partidas:
    print(f"INSERT INTO Joga (partida_id, arbitro_id) VALUES ({p['id']}, {p['arbitro_id']});")

print("\n-- INSERT Tabela Final")
for t in tabela_final:
    print(f"INSERT INTO Tabela (campeonato_id, time_id, pontos, vitorias, empates, derrotas, gols_pro, gols_contra, saldo_gols, posicao_final) VALUES ({t['campeonato_id']}, {t['time_id']}, {t['pontos']}, {t['vitorias']}, {t['empates']}, {t['derrotas']}, {t['gols_pro']}, {t['gols_contra']}, {t['saldo_gols']}, {t['posicao_final']});")
